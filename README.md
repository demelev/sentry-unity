...
To use this specific version of the SDK, append `#4.1.1-trackman` to the URL, but note that this will stop Unity from suggesting version updates automatically.
