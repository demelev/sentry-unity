...
- Bump .NET SDK from v3.35.0 to v5.5.0 ([#280](https://github.com/demelev/sentry-unity/pull/280))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#550)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/3.35.0...5.5.0)
