...
- Bump .NET SDK from v3.35.0 to v5.16.1 ([#366](https://github.com/demelev/sentry-unity/pull/366))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#5161)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/3.35.0...5.16.1)
