...
- Bump .NET SDK from v3.35.0 to v5.15.0 ([#349](https://github.com/demelev/sentry-unity/pull/349))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#5150)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/3.35.0...5.15.0)
