...
- Bump .NET SDK from v3.35.0 to v5.8.0 ([#303](https://github.com/demelev/sentry-unity/pull/303))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#580)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/3.35.0...5.8.0)
