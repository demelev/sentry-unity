...
- Bump .NET SDK from v6.0.0 to v6.10.0 ([#536](https://github.com/demelev/sentry-unity/pull/536))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#6100)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/6.0.0...6.10.0)
