...
- Bump .NET SDK from v3.35.0 to v5.0.0 ([#240](https://github.com/demelev/sentry-unity/pull/240))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#500)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/3.35.0...5.0.0)
