...
- Bump .NET SDK from v6.0.0 to v6.8.0 ([#516](https://github.com/demelev/sentry-unity/pull/516))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#680)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/6.0.0...6.8.0)
