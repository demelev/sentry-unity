...
- Bump .NET SDK from v6.0.0 to v6.7.0 ([#506](https://github.com/demelev/sentry-unity/pull/506))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#670)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/6.0.0...6.7.0)
