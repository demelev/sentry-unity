...
- Bump .NET SDK from v6.0.0 to v6.2.0 ([#431](https://github.com/demelev/sentry-unity/pull/431))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#620)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/6.0.0...6.2.0)
