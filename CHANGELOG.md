...
- Bump .NET SDK from v3.35.0 to v4.4.0 ([#126](https://github.com/demelev/sentry-unity/pull/126))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#440)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/3.35.0...4.4.0)
