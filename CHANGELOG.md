...
- Bump .NET SDK from v3.35.0 to v5.10.0 ([#313](https://github.com/demelev/sentry-unity/pull/313))
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#5100)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/3.35.0...5.10.0)
